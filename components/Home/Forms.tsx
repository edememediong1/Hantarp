...
function Forms() {
  return (
    <form className="flex flex-col bg-[#004A61] px-4 py-8 md:p-8 gap-4 w-full h-full text-white justify-around">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <input type="phone" name="phone" id="phone"  placeholder="Phone" className="outline-none border-b-1 w-full p-2"/>
        </div>
        <div className="">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 md:gap-2 lg:gap-4 mt-4 lg:w-[80%] text-[16px] lg:text-[18px]">
            <span className="flex items-center gap-2">
              <input type="radio" name="feedback" id="inquiry" width={30} height={30}/>
              <label htmlFor="inquiry">General Inquiry</label>
            </span>
            <span className="flex items-center gap-2">
              <input type="radio" name="feedback" id="inquiry" />
              <label htmlFor="complaint">Service Complaint</label>
            </span>
            <span className="flex items-center gap-2">
              <input type="radio" name="feedback" id="support" />
              <label htmlFor="support">Technical Support</label>
            </span>
            <span className="flex items-center gap-2">
              <input type="radio" name="feedback" id="suggest" />
        ...
        <button className="bg-[#FFD488] w-full text-[#000] rounded-full p-2 hover:bg-amber-500 font-medium">Send</button>
