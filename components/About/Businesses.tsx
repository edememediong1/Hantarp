  ...
  return (
    <div className='bg-[#FFDAA3] p-4 md:p-8 space-y-6'>
        ...
        <section className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <article className='flex flex-col gap-4 rounded-2xl p-4 lg:h-[300px] text-white bg-[#B38211] justify-center md:px-8 '>
            ...
            <article className='flex flex-col gap-4 rounded-2xl p-4 lg:h-[300px] text-white  justify-center md:px-8 bg-[#B38211]'>
